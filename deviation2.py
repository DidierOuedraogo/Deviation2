...
if df is not None:
    ...
    with tabs[0]:  # Exploration des données
        ...
        with col2:
            ...
            st.markdown(f"""
            <div style="margin-top: 1rem; background-color: #F8F9FA; padding: 1rem; border-radius: 6px; border-left: 4px solid {{'Granite': '#FF6B6B', 'Schiste': '#4ECDC4', 'Gneiss': '#45B7D1', 'Calcaire': '#FFBE0B', 'Basalte': '#9F84BD'}.get(most_deviated, '#4F8BF9')};">
